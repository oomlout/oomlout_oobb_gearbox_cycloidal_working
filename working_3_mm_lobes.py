...
def make_scad_drive_shaft_input(**kwargs):
    ...
    kwargs["type"] = "oomlout_oobb_gearbox_cycloidal_working_3_mm_lobe_drive_shaft_input"
     # default sets
...
def make_scad_drive_shaft_output_inner(**kwargs):
    ...
    kwargs["type"] = "oomlout_oobb_gearbox_cycloidal_working_3_mm_lobe_drive_shaft_output_inner"
     # default sets
    width = kwargs.get("width", 3)
    height = kwargs.get("height", 5)
    thickness = kwargs.get("thickness", 3)
...
def make_scad_drive_shaft_output_outer(**kwargs):
    ...
    kwargs["type"] = "oomlout_oobb_gearbox_cycloidal_working_3_mm_lobe_drive_shaft_output_outer"
     # default sets
    width = kwargs.get("width", 3)
    height = kwargs.get("height", 5)
    thickness = kwargs.get("thickness", 3)
...
def make_scad_full(**kwargs):
    ...
    kwargs["type"] = "oomlout_oobb_gearbox_cycloidal_working_3_mm_lobe_full"
...
def make_scad_outer_rotor(**kwargs):
    ...
    kwargs["type"] = "oomlout_oobb_gearbox_cycloidal_working_3_mm_lobe_outer_rotor"
     # default sets
    width = kwargs.get("width", 3)
    height = kwargs.get("height", 5)
    thickness = kwargs.get("thickness", 3)
...
def make_scad_inner_rotor(**kwargs):
    ...
    kwargs["type"] = "oomlout_oobb_gearbox_cycloidal_working_3_mm_lobe_inner_rotor"
     # default sets
    width = kwargs.get("width", 3)
    height = kwargs.get("height", 5)
    thickness = kwargs.get("thickness", 3)
